...
import com.example.zy5.bean.UserInfo;
import com.example.zy5.database.UserDBHelper;
import com.example.zy5.util.DateUtil;
import com.example.zy5.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","学校用户", "18990021 李润徽"};
